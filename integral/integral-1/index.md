---
url: /integral/integral-1/index.md
---
## Part 1 集合
...
>
> $$
> A = {a\_1, a\_2, \ldots, a\_i, \ldots}, \quad B = {b\_1, b\_2, \ldots, b\_j, \ldots}.
> $$
> 于是 $A \times B$ 可表示为
>
> $$
> A \times B = {(a\_i, b\_j) \mid i, j = 1, 2, \ldots}.
> $$
> 我们可以按照“字典法则”将 $A \times B$ 中的元素排成一列：
>
> $$
> A \times B : (a\_1, b\_1), (a\_1, b\_2), (a\_2, b\_1), (a\_2, b\_2), (a\_3, b\_2), (a\_3, b\_1), \ldots
> $$
> 所谓“字典法则”就是当  $i + j < k + l$  或  $i + j = k + l$  但  $i < k$  时，要求  $(a\_i, b\_j)$  排在  $(a\_k, b\_l)$  前面. 按照可数集的定义， $A \times B$  是可数集.
...
>
> $$
> p\_1 = 2, p\_2, p\_3, \cdots, p\_k.
> $$
> 考虑正整数 $n = 1 + p\_1 p\_2 \cdots p\_k$. 因为 $n > p\_i (1 \leqslant i \leqslant k)$，故 $n$ 不是素数. 因此其因子分解中必含有某个素因子 $p\_i$，即 $p\_i$ 整除 $n$. 根据 $n$ 的定义，这是不可能的
>
...
$$
(a + b)^n = \sum\_{k=0}^{n} C\_n^k a^k b^{n-k}, \quad \forall a, b \in \mathbb{R}.
$$
常用不等式中，一个是三角不等式，即
