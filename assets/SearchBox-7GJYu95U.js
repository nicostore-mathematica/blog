import { i as getCurrentScope, j as onScopeDispose, t as toValue, s as shallowRef, k as watch, l as computed, _ as _export_sfc, c as createElementBlock, o as openBlock, a as createBaseVNode, m as defineComponent, n as useRouteLocale, p as useLocale, q as toRef, v as computedAsync, g as ref, x as useSessionStorage, y as debouncedWatch, z as nextTick, A as onMounted, B as onKeyStroke, f as useRouter, C as useEventListener, D as useScrollLock, E as onBeforeUnmount, F as createBlock, G as withModifiers, H as withDirectives, d as createVNode, h as unref, I as vModelText, J as isRef, K as createCommentVNode, L as renderList, M as normalizeClass, N as withBase, O as Fragment, b as createTextVNode, P as toDisplayString, T as Teleport, Q as markRaw, R as useSearchIndex } from "./app-C973mz5j.js";
...
const BackIcon = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2]]);
const _sfc_main$2 = {};
const _hoisted_1$2 = {
  width: "18",
  height: "18",
...
const ClearIcon = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1]]);
const _sfc_main$1 = {};
const _hoisted_1$1 = {
  width: "18",
  height: "18",
...
const SearchIcon = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render]]);
...
const _hoisted_9 = ["id", "role", "aria-labelledby"];
const _hoisted_10 = ["aria-selected"];
const _hoisted_11 = ["href", "aria-label", "onMouseenter", "onFocusin", "onClick"];
const _hoisted_12 = { class: "titles" };
const _hoisted_13 = ["innerHTML"];
const _hoisted_14 = { class: "title main" };
const _hoisted_15 = ["innerHTML"];
const _hoisted_16 = {
  key: 0,
  class: "no-results"
};
const _hoisted_17 = { class: "search-keyboard-shortcuts" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const locale = useLocale(toRef(() => __props.locales));
    const el = shallowRef();
      ...
      async () => markRaw(
        MiniSearch.loadJSON(
          (await searchIndexData.value[routeLocale.value]?.())?.default,
          {
            ...
            ...__props.options.miniSearch?.searchOptions,
            ...__props.options.miniSearch?.options
          }
        )
      )
    );
    const disableQueryPersistence = computed(
      () => __props.options?.disableQueryPersistence === true
    );
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", _hoisted_2, [
            createBaseVNode("form", {
              class: "search-bar",
              onPointerup: _cache[3] || (_cache[3] = ($event) => onSearchBarClick($event)),
              ...
              createBaseVNode("label", {
                ...
                createVNode(SearchIcon, { class: "search-icon" })
              ], 8, _hoisted_3),
              createBaseVNode("div", _hoisted_4, [
                createBaseVNode("button", {
                  class: "back-button",
                  title: unref(locale).backButtonTitle,
              ...
              createBaseVNode("div", _hoisted_7, [
                createBaseVNode("button", {
                  ...
                  title: unref(locale).resetButtonTitle,
                  onClick: resetSearch
                }, [
                  createVNode(ClearIcon)
                ], 8, _hoisted_8)
              ])
            ], 32),
            createBaseVNode("ul", {
              ...
              class: "results",
              onMousemove: _cache[5] || (_cache[5] = ($event) => disableMouseOver.value = false)
            }, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(results.value, (p, index) => {
                return openBlock(), createElementBlock("li", {
                  ...
                  createBaseVNode("a", {
                    ...
                    onClick: ($event) => selectedClick($event, p)
                  }, [
                    createBaseVNode("div", null, [
                      createBaseVNode("div", _hoisted_12, [
                        _cache[7] || (_cache[7] = createBaseVNode("span", { class: "title-icon" }, "#", -1)),
                        (openBlock(true), createElementBlock(Fragment, null, renderList(p.titles, (t, i) => {
              ...
              unref(filterText) && !results.value.length && enableNoResults.value ? (openBlock(), createElementBlock("li", _hoisted_16, [
                createTextVNode(toDisplayString(unref(locale).noResultsText) + ' "', 1),
            ...
            createBaseVNode("div", _hoisted_17, [
              createBaseVNode("span", null, [
                createBaseVNode("kbd", {
                  "aria-label": unref(locale).footer?.navigateUpKeyAriaLabel ?? ""
                }, [..._cache[9] || (_cache[9] = [
                  createBaseVNode("svg", {
                    width: "14",
                    height: "14",
                ...
                createBaseVNode("kbd", {
                  "aria-label": unref(locale).footer?.navigateDownKeyAriaLabel ?? ""
                }, [..._cache[10] || (_cache[10] = [
                  createBaseVNode("svg", {
                    width: "14",
                    height: "14",
                ...
                createTextVNode(" " + toDisplayString(unref(locale).footer?.navigateText ?? ""), 1)
              ]),
              createBaseVNode("span", null, [
                createBaseVNode("kbd", {
                  "aria-label": unref(locale).footer?.selectKeyAriaLabel ?? ""
                }, [..._cache[11] || (_cache[11] = [
                  createBaseVNode("svg", {
                    width: "14",
                    height: "14",
                ...
                createTextVNode(" " + toDisplayString(unref(locale).footer?.selectText ?? ""), 1)
              ]),
              createBaseVNode("span", null, [
                createBaseVNode("kbd", {
                  "aria-label": unref(locale).footer?.closeKeyAriaLabel ?? ""
                }, "esc", 8, _hoisted_21),
                createTextVNode(" " + toDisplayString(unref(locale).footer?.closeText ?? ""), 1)
              ])
            ])
          ])
        ], 8, _hoisted_1)
...
const SearchBox = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9b677b31"]]);
export {
